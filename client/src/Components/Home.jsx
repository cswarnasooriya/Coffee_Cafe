            ...
            <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className='pt-20 sm:order-1 order-2'>
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold">
                        We are the Richest <span className="text-primary font-cursive">Coffee</span> in Sri Lanka...
                    </h1>
                ...
                {/* image section */}
                <div className="min-h-[420px] flex justify-center items-center order-1 sm:order-2 mt-8 sm:mt-0 relative">
                    ...
                    <div className="bg-gradient-to-r from-primary to-secondary absolute top-12 right-10 p-3 rounded-xl">
